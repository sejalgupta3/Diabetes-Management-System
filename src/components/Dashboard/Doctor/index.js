    	        ...
    	        <div className="row">
    	          <div className="side-nav col-md-2">
    	            <div className="list-group ">
    	              <NavLink to="/dashboard/searchPatient" className="list-group-item">Search Patient</NavLink>
    	              <NavLink to="/dashboard/Schedule" className="list-group-item">See my Schedule</NavLink>
    	              </div>
    	          </div>
    	          <Switch>
